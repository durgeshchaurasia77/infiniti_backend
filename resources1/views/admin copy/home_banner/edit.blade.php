                                ...
                                <div class="first d-flex" style="gap:30px;">
                                    ...
                                    <div class="mb-2 w-100">
                                        <div class="mb-2 w-100">
                                            ...
                                            <input type="url" class="form-control" name="youtube_link" id="youtube_link" placeholder="Please Enter Youtube Link..." value="{{ $homeBannerData->youtube_link ?? '' }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-2 w-100">
                                    <label class="col-form-label">Sub Title<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="subtitle" id="subtitle" placeholder="Please Enter Sub Title..."  required value="{{ $homeBannerData->subtitle ?? '' }}">
                                </div>
                                <div id="dynamic-fields">
                                    @if(isset($homeBannerData->details) && count($homeBannerData->details) > 0)
                                        @foreach($homeBannerData->details as $key => $detail)
