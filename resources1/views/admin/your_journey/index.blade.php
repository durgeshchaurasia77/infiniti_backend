							...
							<div class="row align-items-center">
								...
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="{{ route('your-journey-list')}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <button type="button" data-href="{{ route('your-journey-edit', [$data->id]) }}" class="btn btn-secondary edit_model" data-bs-toggle="modal" data-bs-target="#edit_model" title="Edit">
                                                                <i class="feather-edit"></i>
                                                            </button>
                                                            <button @if($data->status == 1) class="btn btn-danger btn-xs mw-75 ml-2 mr-2" id="activateBtn" @else class="btn btn-success btn-xs mw-75 ml-2 mr-2" id="deactivateBtn" @endif href="{{ route('your-journey-status-update', [$data->id]) }}" title="Status">
                                                                @if($data->status == 1) <i class="feather-lock"></i> @else <i class="feather-unlock"></i> @endif
                                                            </button>
                                                            <button id="delete" href="{{ route('your-journey.delete',[$data->id]) }}" class="btn btn-danger btn-xs mr-2 jsgrid-delete-button" type="button" title="Delete"><i class="fa fa-trash"></i>
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
				...
				<div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            {{ isset($people) ? 'Edit Our Journey' : 'Add New Our Journey' }}
                        </h5>
                    ...
                    <form action="{{ route('your-journey-store') }}"
                        method="POST"
                        class="formSubmit"
