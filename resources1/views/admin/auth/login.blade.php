...
<body class="account-page">
        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-01">
                <div
                    ...
                    <form action="{{route('admin_login_submit')}}" method="post" id="formSubmitlogin" autocomplete="off" class="flex-fill">
                        @csrf
                        <div class="mx-auto mw-450">
                            <div class="text-center mb-4">
                                {{-- <img src="{{ asset('assets/img/global_logo.png') }}" class="img-fluid" alt="Logo"> --}}

                                <h4 class="mb-2 fs-20"> Admin Panel</h4>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="pass-group">
                                    <input type="password" name="password" value="{{ old('password') }}"  class="pass-input form-control">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                {{-- <div class="text-end">
                                    <a href="{{ route('admin_forgot_password') }}" class="text-primary fw-medium link-hover">Forgot
                                        Password?</a>
                                </div> --}}
                            </div>
                            <div class="mb-3">
                                <button type="submit" class="btn btn-primary w-100 loderButton"><span class="spinner-grow spinner-grow-sm loderIcon" role="status" aria-hidden="true" style="display: none;"></span>Sign In</button>
                            </div>
    ...
    <script type="text/javascript">
     $(document).on('submit', 'form#formSubmitlogin', function(e) {
