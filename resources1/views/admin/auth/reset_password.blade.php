        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-03">
                <div
                    ...
                    <form action="{{route('admin_updatePassword',[$email])}}" method="post" autocomplete="off" class="flex-fill formSubmit">
                        @csrf
                        ...
                        <div class="mx-auto mw-450">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="pass-group">
                                    <input type="password" name="confirm_password" maxlength="15"  class="pass-input form-control">
                                    <span class="ti toggle-password ti-eye-off"></span>
                                </div>
                            </div>

                            <div class="mb-3">
                                <button name="submit_type" type="submit" value="Submit" class="btn btn-primary w-100 loderButton"><span class="spinner-grow spinner-grow-sm loderIcon" role="status" aria-hidden="true" style="display: none;"></span>Submit</button>
                            </div>
