            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <h4 class="page-title">Client Satisfation List</h4>
                        </div>
                        <div class="col-sm-4 text-sm-end">
                            <div class="head-icons">
                                <a href="{{ route('client-satisfaction-list') }}"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-8 text-sm-end">
                                <a href="javascript:void(0);"
                                   ...
                                   title="Add Client Satisfation">
                                    <i class="ti ti-square-rounded-plus me-2"></i>
                                    Add Client Satisfation
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    {{-- Edit --}}
                                                    <button type="button"
                                                            data-href="{{ route('client-satisfaction-edit', [$data->id]) }}"
                                                    ...
                                                    <button
                                                        ...
                                                        @else
                                                            ...
                                                            id="deactivateBtn"
                                                        @endif
                                                        href="{{ route('client-satisfaction-status-update', [$data->id]) }}"
                                                        title="Status">
                                                        @if($data->status == 1)
                                                    ...
                                                    {{-- Delete --}}
                                                    <button id="delete"
                                                            href="{{ route('client-satisfaction.delete', [$data->id]) }}"
                                                            class="btn btn-danger btn-xs ml-2"
                                                            type="button"
                                                            title="Delete">
...
<!-- Add / Edit Client Satisfation -->
<div class="modal fade" id="add_case_study" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Add New Client Satisfation</h5>
            ...
            <form action="{{ route('client-satisfaction-store') }}"
                  method="POST"
                  class="formSubmit"
