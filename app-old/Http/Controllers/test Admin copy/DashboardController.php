...
class DashboardController extends Controller
{
    ...
    {
        $blogsNews_count    = $this->blogsNews->count();
        $ourServices_count  = $this->ourServices->count();
        $testimonials_count = $this->testimonials->count();
        $contactUs_count    = $this->contactUs->count();
        $getEnquiry_count   = $this->getEnquiry->count();
        $expactEnquery_count= $this->expactEnquery->count();
        $comment_count    = $this->comment->count();
        $videoLibrary_count   = $this->videoLibrary->count();
        $reportConsultation_count= $this->reportConsultation->count();
