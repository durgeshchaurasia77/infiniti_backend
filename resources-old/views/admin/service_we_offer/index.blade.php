            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <h4 class="page-title">Service We Offer List</h4>
                        </div>
                        <div class="col-sm-4 text-sm-end">
                            <div class="head-icons">
                                <a href="{{ route('service-we-offer-list') }}"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-8 text-sm-end">
                                <a href="javascript:void(0);"
                                   ...
                                   title="Add Service We Offer">
                                    <i class="ti ti-square-rounded-plus me-2"></i>
                                    Add Service We Offer
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    {{-- Edit --}}
                                                    <button type="button"
                                                            data-href="{{ route('service-we-offer-edit', [$data->id]) }}"
                                                    ...
                                                    <button
                                                        ...
                                                        @else
                                                            ...
                                                            id="deactivateBtn"
                                                        @endif
                                                        href="{{ route('service-we-offer-status-update', [$data->id]) }}"
                                                        title="Status">
                                                        @if($data->status == 1)
                                                    ...
                                                    {{-- Delete --}}
                                                    <button id="delete"
                                                            href="{{ route('service-we-offer.delete', [$data->id]) }}"
                                                            class="btn btn-danger btn-xs ml-2"
                                                            type="button"
                                                            title="Delete">
...
<!-- Add / Edit Service We Offer -->
<div class="modal fade" id="add_case_study" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Add New Service We Offer</h5>
            ...
            <form action="{{ route('service-we-offer-store') }}"
                  method="POST"
                  class="formSubmit"
