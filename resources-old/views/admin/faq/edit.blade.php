<div class="modal-dialog modal-dialog-centered">
	<div class="modal-content">
		...
		<form action="{{ route('faq-update') }}" method="post" id="" class="formSubmit" enctype="multipart/form-data">
    		@csrf
			...
			<div class="modal-body">
				<div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea name="question" class="form-control" id="question" required>{!! $faqData->question !!}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="col-form-label">Answer<span class="text-danger">*</span></label>
                        <textarea name="answer" class="form-control" id="answer" required>{!! $faqData->answer !!}</textarea>
                    </div>
				</div>
			</div>
