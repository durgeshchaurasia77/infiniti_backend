                        ...
                        <td style="width:50%;padding:20px;vertical-align:top">
                          ...
                          <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="font-weight:600;font-size:14px;">Email:</span> {{$mailArray['email'] ?? ''}}</p>
                           ...
                           @if(isset($mailArray['question']) )
                              <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="font-weight:600;font-size:14px;">Question:</span> {{$mailArray['question'] ?? ''}}</p>
                           @endif
                           @if(isset($mailArray['question_type']) )
                              <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="font-weight:600;font-size:14px;">Type:</span> {{$mailArray['question_type'] ?? 'None'}}</p>
                           @endif
