                ...
                <div class="col-md-12">
                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col-sm-8">
                                <h4 class="page-title">Add New Frro Location</h4>
                            </div>
                        </div>
                    </div>
                    <!-- /Page Header -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('frro-location-store') }}" method="post" class="formSubmit" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="first d-flex " style="gap:40px;">
                                        ...
                                        <div class="mb-2 w-100">
                                            ...
                                            <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Please Enter Latitude" required onkeypress="return validateLatitudeInput(event)" oninput="validateLatitudeRange(this)">
                                        </div>
                                        <div class="mb-2 w-100">
                                            <label class="col-form-label">Longitude<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Please Enter Longitude" required     onkeypress="return validateInput(event, -180, 180)" oninput="validateRange(this, -180, 180)">
                                        </div>
                                    </div>
                                    <div class="first d-flex " style="gap:40px;">
                                        <div class="mb-2 w-100">
