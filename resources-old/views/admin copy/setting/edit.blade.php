                        ...
                        <form action="{{ route('setting-update') }}" method="post"  class="formSubmit" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                              <div class="modal-body">
                                ...
                                <div class="first d-flex " style="gap:30px;">
                                    <div class="mb-2 w-100">
                                        <label class="col-form-label">Footer Image<span class="text-danger">*</span></label>
                                        <input type="file" class="form-control" name="footer_image" id="footer_image"  >
                                        <div class="p-3 bg-success w-50" >
                                            @if (isset($settingData->footer_image))
                                                <img src="{{asset($settingData->footer_image)}}"  width="80%" height="5%" style="padding:9px">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="mb-3 w-100">
