...
@section('content')
                    ...
                    <div class="container">
                        <div class="row g-5 banner-carousel-text-one">
                            <div class="col-xl-12 col-lg-12">
                                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">{{$ourservicesdetails->title ?? ''}}</h4>
                                    <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                                        <li class="breadcrumb-item"><a href="{{route('web_home')}}" class="text-white">Home</a></li>
                                        <li class="breadcrumb-item active text-primary">{{$ourservicesdetails->title ?? ''}}</li>
                                    </ol>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid services-details py-5 px-5">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 mb-4">
                        <h4 class="mb-4">{{$ourservicesdetails->description ?? ''}}</h4>
                        {!! $ourservicesdetails->summary ?? '' !!}
                        <div>
                            <a href="{{route('frro-optin')}}">
