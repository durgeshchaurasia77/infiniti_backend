							...
							<div class="row align-items-center">
								...
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="{{ route('blog-list')}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="{{ route('blog-edit', [base64_encode($data->id)]) }}" class="btn btn-secondary" title="Edit">
                                                                <i class="feather-edit"></i>
                                                            </a>
                                                            <button @if($data->status == 1)
                                                             class="btn btn-danger btn-xs mw-75 ml-2 mr-2" id="activateBtn" @else class="btn btn-success btn-xs mw-75 ml-2 mr-2" id="deactivateBtn" @endif href="{{ route('blog-status-update', [$data->id]) }}" title="Status">
