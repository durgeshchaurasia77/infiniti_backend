            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <h4 class="page-title">Leverage Ai List</h4>
                        </div>
                        <div class="col-sm-4 text-sm-end">
                            <div class="head-icons">
                                <a href="{{ route('leverage-ai-list') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    {{-- Edit --}}
                                                    <button type="button"
                                                            data-href="{{ route('leverage-ai-edit', [$data->id]) }}"
                                                    ...
                                                    <button
                                                        ...
                                                        @else
                                                            ...
                                                            id="deactivateBtn"
                                                        @endif
                                                        href="{{ route('leverage-ai-status-update', [$data->id]) }}"
                                                        title="Status">
                                                        @if($data->status == 1)
                                                    ...
                                                    {{-- Delete --}}
                                                    <button id="delete"
                                                            href="{{ route('leverage-ai.delete', [$data->id]) }}"
                                                            class="btn btn-danger btn-xs ml-2"
                                                            type="button"
                                                            title="Delete">
...
<div class="modal fade" id="add_case_study" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('leverage-ai-store') }}"
                  method="POST"
                  class="formSubmit"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="col-form-label">
                            Leverage Ai Name <span class="text-danger">*</span>
                        </label>
                        <input type="text"
                               class="form-control"
                               name="name"
                               placeholder="Enter Leverage Ai name"
                               required>
                    </div>
