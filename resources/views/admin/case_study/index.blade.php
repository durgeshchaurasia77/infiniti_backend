            ...
            <div class="col-md-12">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <h4 class="page-title">Case Study List</h4>
                        </div>
                        <div class="col-sm-4 text-sm-end">
                            <div class="head-icons">
                                <a href="{{ route('case-study-list') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    {{-- Edit --}}
                                                    <button type="button"
                                                            data-href="{{ route('case-study-edit', [$data->id]) }}"
                                                    ...
                                                    <button
                                                        ...
                                                        @else
                                                            ...
                                                            id="deactivateBtn"
                                                        @endif
                                                        href="{{ route('case-study-status-update', [$data->id]) }}"
                                                        title="Status">
                                                        @if($data->status == 1)
                                                    ...
                                                    {{-- Delete --}}
                                                    <button id="delete"
                                                            href="{{ route('case-study.delete', [$data->id]) }}"
                                                            class="btn btn-danger btn-xs ml-2"
                                                            type="button"
                                                            title="Delete">
...
<div class="modal fade" id="add_case_study" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('case-study-store') }}"
                  method="POST"
                  class="formSubmit"
