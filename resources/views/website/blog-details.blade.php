...
<!-- ===== Blog ===== -->
<section class="blog-details-blog-wrapper">
  <div class="container">
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        <div class="blog-details-blog-content">
          ...
          <!-- <p>
            ...
            from automation to predictive analytics. AI is becoming the backbone
         ...
         <div class="blog-details-blog-meta">
          ...
          <p>
            AI improves efficiency, reduces costs, and provides data-driven insights
      ...
      <!-- RIGHT SIDEBAR -->
      <div class="col-lg-4">
        <div class="blog-details-blog-sidebar gradient-sidebar">
