...
<div class="portfolio-content-tab-top">
    ...
    {{-- <div class="portfolio-content-tab-top">
        ...
        <!-- CARD 1 -->
        <div class="portfolio-card-tab-top active" data-key="all">
            <div class="portfolio-text-tab-top">
            <h2>Preeple – Social Media Platform</h2>
            <p>Social platform for thoughts, opinions and media sharing.</p>
            <div class="meta-tab-top">
                <div><span>Country</span><strong>Nigeria</strong></div>
                <div><span>Platforms</span><strong>iOS</strong></div>
            </div>
            </div>
            <div class="portfolio-image-tab-top">
            <img src="{{asset('website1/assets/images/airlane.jpg')}}">
            </div>
        </div>
        <div class="portfolio-card-tab-top active" data-key="all">
        ...
        <!-- CARD 2 -->
        <div class="portfolio-card-tab-top" data-key="agriculture">
            <div class="portfolio-text-tab-top">
            <h2>Agriculture Management App</h2>
            <p>Smart farming app for crop monitoring and analytics.</p>
            <div class="meta-tab-top">
                <div><span>Country</span><strong>India</strong></div>
                <div><span>Platforms</span><strong>Android</strong></div>
            </div>
            </div>
            <div class="portfolio-image-tab-top">
            <img src="{{asset('website1/assets/images/agriculture')}}.jpg">
            </div>
        </div>
        <div class="portfolio-card-tab-top" data-key="agriculture">
            <div class="portfolio-text-tab-top">
        ...
        <!-- CARD 3 -->
        <div class="portfolio-card-tab-top" data-key="astrology">
            <div class="portfolio-text-tab-top">
            <h2>Astrology Prediction App</h2>
            <p>Daily horoscope & astrology based guidance app.</p>
            <div class="meta-tab-top">
                <div><span>Country</span><strong>USA</strong></div>
                <div><span>Platforms</span><strong>iOS</strong></div>
            </div>
            </div>
            <div class="portfolio-image-tab-top">
            <img src="{{asset('website1/assets/images/astrology.j')}}pg">
            </div>
        </div>
        <div class="portfolio-card-tab-top" data-key="astrology">
            <div class="portfolio-text-tab-top">
        ...
        <div class="portfolio-card-tab-top" data-key="beauty">
            <div class="portfolio-text-tab-top">
            <h2>Astrology Prediction App</h2>
            <p>Daily horoscope & astrology based guidance app.</p>
            <div class="meta-tab-top">
        ...
        <div class="portfolio-card-tab-top" data-key="dating">
            <div class="portfolio-text-tab-top">
            <h2>Astrology Prediction App</h2>
            <p>Daily horoscope & astrology based guidance app.</p>
            <div class="meta-tab-top">
